...
| :--- | :--- | :--- |
| `.env.example` | Config | Protected |
| `.gitignore` | System | Protected |
| `README.md` | Doc | Protected |
| `index.html` | Entry | Protected |
| `metadata.json` | Meta | Protected |
| `package-lock.json` | Lock | Protected |
| `package.json` | Config | Protected |
| `tsconfig.json` | Config | Protected |
